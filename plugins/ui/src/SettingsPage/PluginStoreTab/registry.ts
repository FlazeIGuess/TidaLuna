...
// Metrics older than this are hidden rather than shown stale or as a zero
...
/**
 * Metrics go stale silently when the generator stops running, so drop them rather than show a wrong number
 */
...
const fetchRegistry = async () => {
	...
	// registry.json carries the metrics, stores.json is the handwritten source without them
