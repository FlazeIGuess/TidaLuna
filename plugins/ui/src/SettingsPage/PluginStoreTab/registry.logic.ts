// Pure decision logic for the store registry, deliberately free of imports so it can be
// unit tested with plain node. registry.ts owns the reactive state and applies these results.
